...
------------- | ------------- | -------------
https://sfh.waow.cat | Load balances/fails over [@RoootTheFox](https://github.com/RoootTheFox)'s and [@PassiHD2004](https://github.com/PassiHD2004)'s Instances | Germany
